...
var NamespaceVariable = /** @class */ (function (_super) {
    ...
    function NamespaceVariable(module) {
        ...
        _this.module
            ...
            _this.originals[name] = _this.module.traceExport(name);
        });
        return _this;
    }
    ...
    NamespaceVariable.prototype.includeVariable = function () {
        ...
        Object.keys(this.originals).forEach(function (original) { return _this.originals[original].includeVariable(); });
        return true;
    };
    ...
    NamespaceVariable.prototype.renderBlock = function (options) {
        ...
        var callee = options.freeze
            ...
            : '';
        var output = this.module.graph.varOrConst + " " + name + " = " + (options.namespaceToStringTag
            ? "{\n" + members.join(',\n') + "\n};"
            : callee + "({\n" + members.join(',\n') + "\n});");
...
var Literal = /** @class */ (function (_super) {
    ...
    Literal.prototype.render = function (code, _options) {
        if (typeof this.value === 'string') {
            code.indentExclusionRanges.push([
                this.start + 1,
                this.end - 1
            ]);
        }
...
var Chunk$1 = /** @class */ (function () {
    ...
    Chunk.prototype.generateEntryExports = function (entryModule, onlyIncluded) {
        var _this = this;
        if (onlyIncluded === void 0) { onlyIncluded = false; }
    ...
    Chunk.prototype.getChunkExportDeclarations = function () {
        ...
        var _loop_1 = function (name) {
            ...
            var localName = expt.variable.getName();
            exports.push({
                local: localName,
    ...
    Chunk.prototype.render = function (options) {
        ...
        return Promise.resolve()
            ...
            if (_this.getExportNames().length === 0 && !magicString.toString().trim()) {
                _this.graph.warn({
                    code: 'EMPTY_BUNDLE',
            ...
            if (outro)
                outro = "\n\n" + outro;
            magicString = finalise(_this, magicString.trim(), {
...
function generateChunkName(id, chunkNames, startAtTwo, inputRelativeDir) {
    if (startAtTwo === void 0) { startAtTwo = false; }
    if (inputRelativeDir === void 0) { inputRelativeDir = ''; }
    var name;
    if (inputRelativeDir) {
        name = relative(inputRelativeDir, id).replace(/\\/g, '/');
    }
    else {
        name = basename(id);
    }
...
var Graph = /** @class */ (function () {
    ...
    Graph.prototype.buildChunks = function (entryModuleIds, preserveModules) {
        var _this = this;
        // Phase 1 – discovery. We load the entry module and find which
        // modules it imports, and import those, until we have all
        // of the entry module's dependencies
        ...
        return Promise.all(entryModuleIds.map(function (entryId) { return _this.loadModule(entryId); })).then(function (entryModules) {
            ...
            if (preserveModules) {
                if (orderedModules.length === 1) {
                    inputRelativeDir = dirname(orderedModules[0].id);
                }
                else {
                    inputRelativeDir = commondir(orderedModules.map(function (module) { return module.id; }));
                }
            }
            // name the chunks
            ...
            chunkList.forEach(function (chunk) {
                ...
                if (chunk.entryModule) {
                    var entryName = generateChunkName(chunk.entryModule.id, chunkNames, true, inputRelativeDir);
...
function rollup(rawInputOptions) {
    try {
        ...
        if (!Array.isArray(inputOptions_1.input)) {
            inputOptions_1.input = [inputOptions_1.input];
        }
        return graph_1
            .buildChunks(inputOptions_1.input, inputOptions_1.experimentalPreserveModules)
            ...
            function generate(rawOutputOptions) {
                ...
                })).then(function () { return generated; });
                Object.defineProperty(promise, 'code', throwAsyncGenerateError);
                Object.defineProperty(promise, 'map', throwAsyncGenerateError);
                return promise;
            }
            var result = {
                ...
                write: function (outputOptions) {
                    ...
                    return generate(outputOptions).then(function (result) {
                        ...
                        })).then(function () { }); // ensures return void and not void[][]
                    });
                }
            };
            if (inputOptions_1.perf === true) {
...
var Task = /** @class */ (function () {
    ...
    Task.prototype.run = function () {
        ...
        return rollup(options)
            ...
            return Promise.all(_this.outputs.map(function (output) { return result.write(output); }));
        })
            .then(function () {
            ...
            if (_this.cache) {
                ...
                if (_this.cache.modules) {
                    ...
                    var chunks = _this.cache.chunks;
                    for (var chunkName in chunks) {
                        chunks[chunkName].modules.forEach(function (module) {
                            _this.watchFile(module.id);
                        });
                    }
                }
